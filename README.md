...
- Each lesson also carries **tags** from a fixed classification of what the lesson worked on (basics, footwork, turns, elements & variations, body movement, isolations, lead & follow, technique & posture, musicality & rhythm, styling, sensual, tricks & dips, choreography, drills). Tags are shown in the list and on the lesson page, chosen by hand in the form, and suggested by the auto-fill.
